...
1. Testing and use the project. Give feedback on the user experience or suggest new features.
2. Report bugs.
3. Add more conversions from other power system analysis libraries to power-grid-model
