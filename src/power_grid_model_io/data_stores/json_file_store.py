...
from power_grid_model.data_types import PythonDataset
...
class JsonFileStore(BaseDataStore[StructuredData]):
    """
    The json file loader expects each json file to be eiter a single dictionary, or a list of dictonaries.
    """
